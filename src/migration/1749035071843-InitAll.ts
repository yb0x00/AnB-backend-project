...
export class InitAll1749035071843 implements MigrationInterface {
    name = 'InitAll1749035071843'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."notifications_notification_type_enum" AS ENUM('CONTRACT_REQUEST', 'CONTRACT_CREATION_REQUEST', 'CONTRACT_CREATION_READY')`);
