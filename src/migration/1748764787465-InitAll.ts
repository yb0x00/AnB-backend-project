...
export class InitAll1748764787465 implements MigrationInterface {
    name = 'InitAll1748764787465'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "contracts" ("contract_id" SERIAL NOT NULL, "contract_status" character varying(20) NOT NULL, "contract_created_at" TIMESTAMP NOT NULL DEFAULT now(), "contract_expired_at" TIMESTAMP, "contract_termination_reason" character varying(50), "contract_hash" character varying(255), "contract_address" character varying(42), "contract_blockchain_tx_hash" character varying(255), "contract_blockchain_status" character varying(20) NOT NULL, "propertyPropertyId" integer, "lesseeId" integer NOT NULL, "lessorId" integer, "agentId" integer, "previousContractContractId" integer, CONSTRAINT "PK_d4c091e72433a7125d9158170e7" PRIMARY KEY ("contract_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "properties" ADD CONSTRAINT "FK_267da0a5a2f4d92abb5399278d0" FOREIGN KEY ("lessorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "contract_requests" ADD CONSTRAINT "FK_4afaf35d60233dd4d4f62b389dd" FOREIGN KEY ("lesseeId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "contract_requests" ADD CONSTRAINT "FK_e3464a21d948a664e20bbc04d7a" FOREIGN KEY ("lessorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "contract_requests" ADD CONSTRAINT "FK_c8468cad40f2e793e03890e5c38" FOREIGN KEY ("agentId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
